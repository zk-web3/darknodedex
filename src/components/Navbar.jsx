      ...
      <div className="flex items-center">
        ...
        <div className="flex space-x-6 text-lg">
          <Link href="/swap" passHref legacyBehavior>
            <a className="text-neon-pink hover:text-neon-blue transition-colors duration-300 px-3 py-2 rounded-md focus:outline-none focus:ring-2 focus:ring-neon-blue active:scale-95" tabIndex={0} aria-label="Swap page" role="link">
              Swap
            </a>
          </Link>
          <Link href="/liquidity" passHref legacyBehavior>
            <a className="text-neon-pink hover:text-neon-blue transition-colors duration-300 px-3 py-2 rounded-md focus:outline-none focus:ring-2 focus:ring-neon-blue active:scale-95" tabIndex={0} aria-label="Liquidity page" role="link">
              Liquidity
            </a>
          </Link>
          <Link href="/tokens" passHref legacyBehavior>
            <a className="text-neon-pink hover:text-neon-blue transition-colors duration-300 px-3 py-2 rounded-md focus:outline-none focus:ring-2 focus:ring-neon-blue active:scale-95" tabIndex={0} aria-label="Tokens page" role="link">
              Tokens
            </a>
          </Link>
          <Link href="/about" passHref legacyBehavior>
            <a className="text-neon-pink hover:text-neon-blue transition-colors duration-300 px-3 py-2 rounded-md focus:outline-none focus:ring-2 focus:ring-neon-blue active:scale-95" tabIndex={0} aria-label="About page" role="link">
              About
            </a>
          </Link>
        </div>
